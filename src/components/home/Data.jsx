...
const Data = () => {
  return (
    <div className="home__data" data-aos="fade-down" data-aos-duration="1500">
        <h1 className="home__title">
            Nurrizqi Gagah Pratama
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">I am a student at Jenderal Soedirman University majoring in Public Administration, Faculty of Science Social and Political Science. I am a final semester student and just busy with just preparing the thesis so that I have a lot of free time to study and be interested various new things such as programming.</p>
